...
- (void)updateView {
  if (self.seconds) {
    ...
    imgHour1Name = [NSString stringWithFormat:@"%d_", hour / 10];
    imgHour2Name = [NSString stringWithFormat:@"%d_", hour % 10];
    imgMin1Name = [NSString stringWithFormat:@"%d_", minutes / 10];
    imgMin2Name = [NSString stringWithFormat:@"%d_", minutes % 10];
    imgSec1Name = [NSString stringWithFormat:@"%d_", seconds / 10];
    imgSec2Name = [NSString stringWithFormat:@"%d_", seconds % 10];
