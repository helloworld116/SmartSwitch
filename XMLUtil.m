...
#define kSwitchBeginTag 1200

@interface XMLUtil ()
@property(nonatomic, strong) NSMutableDictionary *tagMacDict;
@end
...
//                                                 imageName:imageName];
//    bSwitch.tag = tag;
//    [self.tagMacDict setObject:mac
//                        forKey:[NSString stringWithFormat:@"%d", tag]];
...
//      GDataXMLElement *switchElement = [GDataXMLNode
//      elementWithName:@"switch"];
...
//}
//
//- (NSString *)getMacByTag:(long)tag {
//  return [self.tagMacDict objectForKey:[NSString stringWithFormat:@"%ld",
//  tag]];
//}
@end
